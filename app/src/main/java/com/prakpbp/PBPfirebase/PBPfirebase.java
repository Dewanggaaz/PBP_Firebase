...
public class PBPfirebase extends AppCompatActivity {
        ...
        if (!nim.equals(temp_nim) || !nama.equals(temp_nama) ||
            ...
            databaseReference.setValue(mahasiswa).addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onSuccess(Void aVoid) {
                    Toast.makeText(PBPfirebase.this, "Data berhasil diubah", Toast.LENGTH_SHORT).show();
                    etNIM.setText("");
                    etNama.setText("");
                    etJurusan.setText("");
                    etAngkatan.setText("");
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(PBPfirebase.this, "Data gagal diubah", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
