package com.prakpbp.PBPfirebase;
...
public class ListMhsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance("https://praktikum-firebase-1502f-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("mhs");
                ...
                myAdapter.setOnItemClickListener(new
                                                         MyAdapter.OnItemClickListener() {
                                                             ...
                                                             public void onItemClick(int position) {
                                                                 ...
                                                                 startActivity(new
                                                                         Intent(ListMhsActivity.this, PBPfirebase.class).putExtra("nim", nim)
                                                                 );
                                                             }
                                                         });
            }
